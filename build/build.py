...
Repris de hasaki-studio/site-nat-civ — même générateur, même conventions. Le
contenu éditorial vit dans content/*.md. La page d'accueil est un cas à part :
son corps vit dans build/index.body.html, parce qu'il s'agit de mise en page
...
SITE_URL = "https://examencivique.hasakistudio.fr"
CONTACT_EMAIL = "contact@hasakistudio.fr"
STUDIO = "Hasaki Studio"
ANNEE = "2026"
APP_NAME = "Réussir mon examen civique"
APP_PACKAGE = "com.hasakistudio.examencivique"
...
PAGES = [
    {
        ...
        "title": "Examen civique 2026 : révision QCM en conditions réelles | Hasaki Studio",
        "description": (
            "Préparation à l'examen civique, obligatoire depuis le 1er janvier 2026 pour "
            "la carte de séjour pluriannuelle, la carte de résident et la naturalisation. "
            "QCM en conditions réelles. Application Android bientôt disponible."
        ),
        "og_title": "Réussir mon examen civique",
        "og_description": (
            "40 questions, 45 minutes, 32 bonnes réponses pour valider. Préparez "
            "l'examen civique en conditions réelles."
        ),
        "priority": "1.0",
    },
    {
    ...
    },
    {
        ...
        "eyebrow": "Nous écrire",
        "h1": "Contact",
        "title": "Contact — Réussir mon examen civique | Hasaki Studio",
        "description": (
            "Signaler une erreur dans une question, un problème technique ou une "
    ...
    },
    {
        ...
        "title": "Politique de confidentialité — Réussir mon examen civique | Hasaki Studio",
        "description": (
            "Politique de confidentialité de l'application « Réussir mon examen "
            "civique » : données traitées, bases légales, consentements et vos droits."
        ),
        "priority": "0.5",
    },
    {
    ...
    },
    {
        ...
        "h1": "Mentions légales",
        "title": "Mentions légales — Réussir mon examen civique | Hasaki Studio",
        "description": (
            "Mentions légales de l'application « Réussir mon examen civique » éditée "
            "par Hasaki Studio : éditeur, hébergeur, responsabilité et propriété "
            "intellectuelle."
        ),
        "priority": "0.5",
    },
...
# --------------------------------------------------------------------------
# Convertisseur Markdown (sous-ensemble) — identique à site-nat-civ
# --------------------------------------------------------------------------
...
<li><a class="hover:text-bleu-nuit" href="/conseils">Conseils</a></li>
...
APPLICATION = {
    ...
    "inLanguage": "fr-FR",
    "description": (
        "QCM de préparation à l'examen civique en conditions réelles : 40 questions, "
        "45 minutes, basé sur le programme officiel."
    ),
